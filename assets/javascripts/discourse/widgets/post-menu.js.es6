/**
 * https://github.com/discourse/discourse/blob/master/app/assets/javascripts/discourse/widgets/post-menu.js.es6
 *
 * We are keeping this file to override the `registerButton("reply")` function.
 *
 * Remove this file if we find a better way to do this.
 *  */
...
registerButton("reply", (attrs, state, siteSettings, postMenuSettings) => {
  ...
  // how to check if it doesn't belong to a collective?
